      ...
      <div className="flex w-full items-center justify-between gap-4 px-6 py-4">
        ...
        <div className="flex items-center gap-6">
          <Link
            to="/"
            className="flex items-center hover:opacity-85 transition-opacity"
            aria-label="Investoken - Ir a inicio"
          >
            <img
              src="https://res.cloudinary.com/dhacybdxf/image/upload/v1762901050/Investoken/investoken_solo_logo_oficial_azul_y_blanco_jdbnpk.svg"
              alt="Investoken"
          ...
          <div className="hidden lg:flex items-center gap-2">
            ...
            <Link to="/">
              <Button
                variant="ghost"
                size="lg"
                className="text-base font-medium text-foreground hover:text-primary hover:bg-primary/10 active:bg-primary/15 transition-colors rounded-lg h-10"
              >
                {t("Home")}
              </Button>
            </Link>
            ...
            <NavigationMenu>
              <NavigationMenuList>
                <NavigationMenuItem>
                  <NavigationMenuTrigger className="z-[60]">
                    {t("invest")}
                  </NavigationMenuTrigger>
            ...
            <div className="flex items-center gap-3">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button
                    className="inline-flex items-center gap-2 p-1.5 rounded-full hover:bg-primary/10 transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
                ...
                <DropdownMenuContent align="end" className="w-72 p-0 shadow-lg">
                    ...
                    <div className="flex items-center gap-3">
                      <Avatar className="h-14 w-14 ring-2 ring-primary/30">
                        <AvatarImage
                          ...
                          alt={user?.name || "Usuario"}
                        />
                        <AvatarFallback className="font-bold text-base bg-primary/15 text-primary">
                          {user?.name?.slice(0, 2).toUpperCase() || "US"}
                        </AvatarFallback>
                      </Avatar>
                  ...
                  <div className="p-3 border-b border-border/50 space-y-1">
                    <DropdownMenuItem asChild className="cursor-pointer">
                      <Link
                        to="/profile"
                        className="flex items-center gap-3 px-4 py-3 rounded-md hover:bg-primary/10 active:bg-primary/15 transition-colors"
                      >
                        <svg
                    ...
                    <DropdownMenuItem asChild className="cursor-pointer">
                      <Link
                        to="/create"
                        className="flex items-center gap-3 px-4 py-3 rounded-md hover:bg-emerald/10 active:bg-emerald/15 transition-colors bg-gradient-to-r from-emerald-50/50 to-teal-50/50 dark:from-emerald-950/30 dark:to-teal-950/30 border border-emerald-200/30 dark:border-emerald-800/30"
                      >
                        <svg
