  ...
  return (
    <nav className="border-b border-border/30 bg-background sticky top-0 z-50 shadow-sm">
      ...
      <div className="flex items-center gap-3">
        ...
        {isAuthenticated && (
          <div className="flex items-center gap-3">
            {/* Balance Badge - Elegant Display */}
            <div className="hidden sm:flex px-4 py-2 rounded-lg bg-accent/15 backdrop-blur-sm border border-accent/40 shadow-sm">
              <span className="text-sm font-semibold text-accent">$ 5,432.50</span>
            </div>
