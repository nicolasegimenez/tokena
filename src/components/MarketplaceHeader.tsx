...
export function MarketplaceHeader({
  ...
  return (
    <div className="border-b bg-gradient-to-r from-white/80 to-white/50 dark:from-slate-900/80 dark:to-slate-800/50 backdrop-blur-xl sticky top-0 z-40 shadow-sm">
