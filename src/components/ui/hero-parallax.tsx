...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-screen md:h-[300vh] py-12 md:py-40 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
