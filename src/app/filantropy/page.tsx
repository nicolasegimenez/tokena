...
const philanthropyProjects = [
  {
    ...
    description_long:
      "El Club Atlético Juventud necesita reunir fondos para viajar a España y competir en la Copa Barcelona 2025. Con tu aporte voluntario, ayudarás a estos jóvenes atletas a cumplir su sueño.",
  ...
  },
  {
    ...
    category: "Educación",
    image:
      "https://res.cloudinary.com/dhacybdxf/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1763240602/5ee3acb7ecd99_1004x565_lyawpb.jpg",
    goalAmount: 50000,
    raisedAmount: 32000,
    ...
    description_long:
      "Ayuda a estudiantes talentosos pero sin recursos a acceder a educación de calidad. Cada aporte contribuye a cambiar vidas.",
  ...
  },
  {
    ...
    image:
      "https://res.cloudinary.com/dhacybdxf/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1763241338/imagen-casa-hogar_m30nib.png",
    goalAmount: 75000,
    raisedAmount: 58000,
    ...
    description_long:
      "Buscamos mejorar las instalaciones y servicios para los niños bajo nuestro cuidado. Tu donación directa llega al beneficiario.",
  ...
  },
  {
    ...
    description_long:
      "Participa en la reforestación del Amazonas. Cada aporte se documenta y puedes ver el impacto de tu donación.",
  ...
  },
  {
    ...
    description_long:
      "Brindamos servicios de salud gratuitos a comunidades rurales. Tu aporte financia medicinas, equipos y personal médico.",
...
const labels = {
  es: {
    ...
    solidarity_subtitle:
      "Contribuye a cambiar vidas. Aportes voluntarios para causas solidarias.",
  ...
  en: {
    ...
    solidarity_subtitle:
      "Contribute to changing lives. Voluntary donations for solidarity causes.",
...
export default function PhilanthropyPage() {
  ...
  const [selectedProject, setSelectedProject] = useState<
    (typeof philanthropyProjects)[0] | null
  >(null);
  ...
  const totalRaised = philanthropyProjects.reduce(
    (sum, p) => sum + p.raisedAmount,
    0
  );
  const totalContributors = philanthropyProjects.reduce(
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-pink-50 to-red-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
            ...
            <div className="md:text-right">
              <div className="bg-gradient-to-r from-red-50 to-pink-50 dark:from-red-950/30 dark:to-pink-950/30 rounded-lg p-4 border border-red-200/30 dark:border-red-800/30">
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  {totalContributors.toLocaleString()} aportantes
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Project Count Label */}
        <div className="mb-6">
          <span className="inline-flex items-center px-3 py-1.5 rounded-md text-sm font-medium bg-red-50 dark:bg-red-950/30 text-red-700 dark:text-red-400 border border-red-200/50 dark:border-red-800/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredProjects.map((project) => (
            <Card
              key={project.id}
              className="group overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border-2 hover:border-red-200 dark:hover:border-red-800 flex flex-col"
            >
              {/* Image */}
              ...
              <CardContent className="space-y-4 flex-grow">
                ...
                <div className="bg-gradient-to-br from-red-50 to-pink-50 dark:from-red-950 dark:to-pink-950 rounded-lg p-4 text-center">
                  ...
                  <p className="text-xs text-muted-foreground">
                    ${(project.raisedAmount / 1000).toFixed(0)}K de $
                    {(project.goalAmount / 1000).toFixed(0)}K
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-red-600">
                      ${project.averageContribution.toFixed(2)}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  <Badge
                    variant="outline"
                    className="text-xs border-red-200/50 dark:border-red-800/50 text-red-600 dark:text-red-400"
                  >
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    {selectedProject.description_long}
                  </p>
                </div>
                ...
                <div className="bg-red-50/50 dark:bg-red-950/20 rounded-lg p-4 border border-red-200/30 dark:border-red-800/30">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Tu aporte contribuye directamente al logro de los objetivos
                    de este proyecto. Cada donación se registra en blockchain
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-slate-50 dark:bg-slate-900/50 rounded-lg p-4">
                    ...
                    <p className="font-semibold">
                      {selectedProject.contributorCount.toLocaleString()}
                    </p>
                  </div>
                  <div className="bg-slate-50 dark:bg-slate-900/50 rounded-lg p-4">
                    <p className="text-xs text-muted-foreground mb-1">
                    ...
                    <p className="font-semibold">
                      ${selectedProject.averageContribution.toFixed(2)}
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="h-3 bg-slate-200 dark:bg-slate-800 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${Math.min((selectedProject.raisedAmount / selectedProject.goalAmount) * 100, 100)}%`,
                      }}
                    />
                  </div>
                  <p className="text-xs text-muted-foreground">
                    ${(selectedProject.raisedAmount / 1000).toFixed(0)}K de $
                    {(selectedProject.goalAmount / 1000).toFixed(0)}K
                  </p>
                </div>
        ...
        <DialogContent className="max-w-md">
          {selectedProject && (
            <>
              <DialogHeader>
                <DialogTitle>
                  {t("contribute")} a {selectedProject.name}
                </DialogTitle>
                <DialogDescription>
                  {language === "es"
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    placeholder={
                      language === "es" ? "Ingresa un monto" : "Enter amount"
                    }
                ...
                <div className="bg-slate-50 dark:bg-slate-900/50 rounded-lg p-3 space-y-2">
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-muted-foreground">
                      {language === "es" ? "Token simbólico" : "Symbolic token"}
                    </span>
                    <span className="font-semibold">
                      {contributionAmount
                        ? Math.floor(parseFloat(contributionAmount) / 10)
                        : 0}{" "}
