        ...
        <div className="lg:col-span-2 flex flex-col gap-8">
          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-sm text-muted-foreground">Duración Ciclo</p>
                <p className="font-semibold">{projectData.investmentDetails.duracionCiclo}</p>
              </div>
              <div className="col-span-2">
                <p className="text-sm text-muted-foreground">Capital Requerido</p>
                <p className="font-semibold">{projectData.investmentDetails.capitalRequerido}</p>
              </div>
              <div className="col-span-2">
                <p className="text-sm text-muted-foreground">Capital Tokenizado</p>
                <p className="font-semibold">{projectData.investmentDetails.capitalTokenizado}</p>
              </div>
              <div className="col-span-2">
                <p className="text-sm text-muted-foreground">Estimación de Retorno</p>
                <p className="font-semibold">{projectData.investmentDetails.estimacionRetorno}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Estructura de Tokenización</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Ventajas de la Tokenización</CardTitle>
            </CardHeader>
            <CardContent>
              <ul className="space-y-3">
