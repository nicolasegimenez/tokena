...
const auctionProjects = [
  {
    ...
    image:
      "https://res.cloudinary.com/dhacybdxf/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1763417178/2015TOY005c01_fordpi.jpg",
    ...
    description_long:
      "Proyecto de tokenización de automóviles usados de alta demanda. Este Toyota Corolla 2015 será comprado, reacondicionado y vendido en subasta pública. Los inversores que participan reciben tokens que representan su inversión y recibirán ganancias proporcionales a su participación.",
    carDetails: {
      brand: "Toyota",
      model: "Corolla",
      year: 2015,
  ...
  },
  {
    ...
    category: "Automóviles",
    image:
      "https://res.cloudinary.com/dhacybdxf/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1763417683/D_NQ_NP_911955-MLA80334559322_112024-F_bhcui2.jpg",
    ...
    description_long:
      "Subasta de una Volkswagen Amarok 4x2, vehículo de carga muy demandado. Incluye reparaciones mecánicas completas y documentación vigente. Los inversores tokenizados participan en la ganancia de la venta.",
    carDetails: {
      brand: "Volkswagen",
      model: "Amarok",
      year: 2012,
  ...
  },
  {
    ...
    category: "Automóviles",
    image:
      "https://res.cloudinary.com/dhacybdxf/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1763417703/fc0c48381abf3a1271ffaed662788d9856c2b86d_k9hgsp.jpg",
    ...
    tokenName: "AUTO-Fiat",
    description_long:
      "Vehículo urbano ideal para la ciudad. Bajo consumo, mantenimiento económico y alta demanda de mercado. Perfecto para inversores que buscan proyectos de corta duración con buenos retornos.",
    carDetails: {
      brand: "Fiat",
      model: "500",
      year: 2018,
  ...
  },
  {
    ...
    category: "Inmuebles",
    image:
      "https://res.cloudinary.com/dhacybdxf/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1763417726/W10_QA_C_C3_B3mo_Asegurarte_De_Que_Una_Inversion_En_Una_Propiedad_Comercial_Sea_Rentable_4_kr1xgm.jpg",
    ...
    description_long:
      "Propiedad comercial de 150 m² en zona céntrica con alto valor comercial. Será reacondiconada y vendida en subasta a través de la plataforma. Inversión tokenizada con transparencia total.",
    propertyDetails: {
  ...
  },
  {
    ...
    category: "Automóviles",
    image:
      "https://res.cloudinary.com/dhacybdxf/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1763417746/nuevo-fiesta-kinetc-1_feqzy7.jpg",
    ...
    description_long:
      "Ford Fiesta KD completamente funcional, bajo costo de mantenimiento y buena demanda en mercado secundario. Apto para inversores con perfil moderado.",
    carDetails: {
      brand: "Ford",
      model: "Fiesta",
      year: 2014,
  ...
  },
  {
    ...
    category: "Automóviles",
    image:
      "https://res.cloudinary.com/dhacybdxf/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1763417784/2723505-0tqbyqcv7u-whr_dnipxu.jpg",
    ...
    description_long:
      "Peugeot 208 GTi con mayor demanda en mercado de autos deportivos. Perfecto para inversores que buscan márgenes de ganancia más altos. Proceso de reacondicionamiento acelerado.",
    carDetails: {
      brand: "Peugeot",
      model: "208 GTi",
      year: 2016,
...
const labels = {
  es: {
    ...
    auctions_subtitle:
      "Invierte en subastas de activos reales con rendimiento comprobado",
...
export default function AuctionsPage() {
  ...
  const categories = ["Automóviles", "Inmuebles"];
  ...
  const totalInvested = auctionProjects.reduce(
    (sum, a) => sum + a.tokenPrice * a.tokensSold,
    0
  );
  const totalInvestors = auctionProjects.reduce(
    (sum, a) => sum + a.buyerCount,
    0
  );
              ...
              <div className="md:text-right">
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-lg p-4 border border-blue-200/30 dark:border-blue-800/30">
                  ...
                  <p className="text-xs text-muted-foreground mt-2">
                    {totalInvestors.toLocaleString()} inversores
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredAuctions.map((auction) => (
            <Card
              key={auction.id}
              className="group overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 border-2 hover:border-blue-200 dark:hover:border-blue-800 flex flex-col"
            >
              {/* Image */}
              ...
              <CardContent className="space-y-4 flex-grow">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div className="col-span-2">
                    ...
                    <p className="font-bold text-lg text-blue-600">
                      {Math.round(auction.currentBid / auction.tokenPrice)}{" "}
                      {auction.tokenName}
                    </p>
                  </div>
                </div>
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <p className="text-xs font-semibold text-blue-600">
                      {Math.round(
                        (auction.tokensSold / auction.tokensAvailable) * 100
                      )}
                      %
                    </p>
                  </div>
                  <div className="h-2 bg-slate-200 dark:bg-slate-800 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${Math.min((auction.tokensSold / auction.tokensAvailable) * 100, 100)}%`,
                      }}
                    />
                  </div>
                </div>
                ...
                <div className="bg-slate-50 dark:bg-slate-900/50 rounded-lg p-3 text-sm space-y-2">
                  <div className="flex items-center gap-2 text-muted-foreground">
                    ...
                    <span>
                      {t("auction_starts")}:{" "}
                      {new Date(auction.auctionStartDate).toLocaleDateString()}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 text-muted-foreground">
                    <Clock className="h-3 w-3" />
                ...
                <div className="flex flex-wrap gap-2">
                  <Badge
                    variant="outline"
                    className="text-xs border-blue-200/50 dark:border-blue-800/50 text-blue-600 dark:text-blue-400"
                  >
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    {selectedAuction.description_long}
                  </p>
                </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center text-sm">
                      ...
                      <span className="font-semibold">
                        ${selectedAuction.totalInvestment.toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between items-center text-sm">
                      <span className="text-muted-foreground">
                      ...
                      <span className="font-semibold text-emerald-600">
                        ${selectedAuction.expectedRevenue.toLocaleString()}
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between items-center text-lg">
                      ...
                      <span className="font-bold text-emerald-600">
                        $
                        {(
                          selectedAuction.expectedRevenue -
                          selectedAuction.totalInvestment
                        ).toLocaleString()}
                      </span>
                    </div>
                    <div className="pt-2 border-t border-emerald-200/30 dark:border-emerald-800/30">
                      <p className="text-sm text-emerald-600 dark:text-emerald-400 font-semibold">
                        {t("expected_return")}:{" "}
                        {selectedAuction.expectedReturn.toFixed(1)}%
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-slate-50 dark:bg-slate-900/50 rounded-lg p-4 border border-slate-200/30 dark:border-slate-800/30">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span>
                        ${selectedAuction.costs.purchase.toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">
                      ...
                      <span>
                        ${selectedAuction.costs.repairs.toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">
                      ...
                      <span>
                        ${selectedAuction.costs.documentation.toLocaleString()}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">
                      ...
                      <span>
                        ${selectedAuction.costs.administration.toLocaleString()}
                      </span>
                    </div>
                ...
                {selectedAuction.category === "Automóviles" &&
                  selectedAuction.carDetails && (
                      ...
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        <div>
                          ...
                          <p className="font-semibold">
                            {selectedAuction.carDetails.brand}
                          </p>
                        </div>
                        <div>
                          <p className="text-muted-foreground text-xs">
                          ...
                          <p className="font-semibold">
                            {selectedAuction.carDetails.model}
                          </p>
                        </div>
                        <div>
                          <p className="text-muted-foreground text-xs">
                          ...
                          <p className="font-semibold">
                            {selectedAuction.carDetails.year}
                          </p>
                        </div>
                        <div>
                          <p className="text-muted-foreground text-xs">
                          ...
                          <p className="font-semibold">
                            {selectedAuction.carDetails.mileage}
                          </p>
                        </div>
                        <div>
                          <p className="text-muted-foreground text-xs">
                          ...
                          <p className="font-semibold">
                            {selectedAuction.carDetails.condition}
                          </p>
                        </div>
                        <div>
                          <p className="text-muted-foreground text-xs">
                          ...
                          <p className="font-semibold">
                            {selectedAuction.carDetails.transmission}
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                {selectedAuction.category === "Inmuebles" &&
                  selectedAuction.propertyDetails && (
                    <div className="bg-blue-50/50 dark:bg-blue-950/20 rounded-lg p-4 border border-blue-200/30 dark:border-blue-800/30">
                      <h3 className="font-semibold mb-3 text-blue-600 dark:text-blue-400">
                        {t("property_details")}
                      </h3>
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        <div>
                          ...
                          <p className="font-semibold">
                            {selectedAuction.propertyDetails.location}
                          </p>
                        </div>
                        <div>
                          <p className="text-muted-foreground text-xs">
                          ...
                          <p className="font-semibold">
                            {selectedAuction.propertyDetails.size}
                          </p>
                        </div>
                        <div>
                          <p className="text-muted-foreground text-xs">
                          ...
                          <p className="font-semibold">
                            {selectedAuction.propertyDetails.condition}
                          </p>
                        </div>
                      </div>
                    </div>
        ...
        <DialogContent className="max-w-md">
          {selectedAuction && (
            <>
              <DialogHeader>
                <DialogTitle>
                  {t("invest")} en {selectedAuction.name}
                </DialogTitle>
                <DialogDescription>
                  {language === "es"
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    placeholder={
                      language === "es"
                        ? `Múltiplos de ${selectedAuction.tokenPrice}`
                        : `Multiples of ${selectedAuction.tokenPrice}`
                    }
                      ...
                      {investmentAmount
                        ? Math.floor(
                            parseFloat(investmentAmount) /
                              selectedAuction.tokenPrice
                          )
                        : 0}{" "}
                      {selectedAuction.tokenName}
                    </span>
                  </div>
                    ...
                    <span className="font-semibold text-emerald-600">
                      ...
                      {investmentAmount
                        ? (Math.floor(
                            ...
                            (selectedAuction.expectedRevenue -
                              selectedAuction.totalInvestment)) /
                          selectedAuction.tokensAvailable
                        : 0}
                    </span>
                  </div>
                ...
                <div className="flex gap-2 pt-4">
                  <Button
                    ...
                    onClick={() => {
                      ...
                      if (
                        isNaN(amount) ||
                        amount < selectedAuction.tokenPrice ||
                        amount > 100000
                      ) {
                        setInvestmentError(
                          language === "es"
